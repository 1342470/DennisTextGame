 ...
 * @author kylej
 */
public class Peter extends Adult implements Person {
    ...
    public Peter(int age, String gender, int strikes, String nickname, int strength, int health, String name) {
        this.age = age;
        this.gender = gender;
