 ...
 * @author kylej
 */
public class DennisSnr extends Adult implements Person,life {
    ...
    public DennisSnr (int age, String gender, int strikes, String nickname, int strength, int health, String name) {
        this.age = age;
        this.gender = gender;
