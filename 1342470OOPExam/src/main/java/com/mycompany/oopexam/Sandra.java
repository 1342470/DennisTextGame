 ...
 * @author kylej
 */
public class Sandra extends Adult implements Person,life {
    ...
    public Sandra(int age, String gender, int strikes, String nickname, int strength, int health, String name) {
        this.age = age;
        this.gender = gender;
