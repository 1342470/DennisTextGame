    ...
    public static void gotoBashStreetSchool(){
        ...
        switch (responce) {
            ...
            case "help":
                ...
                break;
            case "talk to Walter":
                System.out.println("you ask walter where Wilber is ");
                System.out.println("Walker;Where is father? well you'll never find him he's the MI13 Hideout hahaha. OH WAIT NEVERMIND WHAT I SAID");
                System.out.println("has walter isn't the brightest you now know where wilber is would you like to go to MI13 hideout?");
                Scanner gotohideout = new Scanner(System.in);
                String answer = gotohideout.nextLine();
                    if(answer.equals("yes"))
                    {MI13SceretServiceHeadquarters.goToMI13();}
                    else{gotoBashStreetSchool();}
                gotoBashStreetSchool();
                break;
            default:
                gotoBashStreetSchool();
