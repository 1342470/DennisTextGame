 ...
 * @author kylej
 */
public class Godfrey extends Adult implements Person,life {
     ...
     */
    public Godfrey(int age, String gender, int strikes, String nickname, int strength, int health, String name) {
        this.age = age;
        this.gender = gender;
    ...
    public void specialistMove(Person theTroubleMaker) {
        ...
        System.out.println("due to your actions have been arrested by Godfrey ");
    }
