...
public class Shops implements location{
    ...
    public static void toShops(){
        ...
        Granny gran = new Granny(80,"female",0,"Granny",15,100,"Granny Menis","Gnipper");
        ...
        switch (responce) {
            case "shoot sling at slipper":
                ...
                break;
            case "talk to granny":
                System.out.println("you ask granny where wilbur is");;
                System.out.println("Granny; wilbur I've not seen him try asking his son he's likly still at school now");
                toShops();
                break;    
            case "go to the park":
